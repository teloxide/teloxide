...
- Added message entity unparser to recreate rendered Html or Markdown Formatted message from text/caption and `MessageEntity` ([PR 1060](https://github.com/teloxide/teloxide/pull/1060))
