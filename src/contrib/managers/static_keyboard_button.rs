...
/// Represents a manager for static `KeyboardButton`s. Static means dynamic
/// creation. It can create an button with selected text, and parse incoming
/// text messages by this text.
///
/// Example:
/// ```
/// use teloxide::{
///     contrib::managers::StaticKeyboardButtonManager,
