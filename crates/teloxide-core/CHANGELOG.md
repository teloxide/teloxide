...
- `RichMessage`, `InputRichMessage` types and `send_rich_message` method for Telegram's block-structured rich messages, with HTML/Markdown/plain-text rendering helpers on `RichMessage`
