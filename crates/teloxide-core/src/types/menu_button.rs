...
pub enum MenuButton {
    ...
    WebApp {
        ...
        /// [`AnswerWebAppQuery`].
        /// Alternatively, a `t.me` link to a Web App of the bot can be
        /// specified in the object instead of the Web App's URL, in
        /// which case the Web App will be opened as if the user pressed
        /// the link.
        ///
