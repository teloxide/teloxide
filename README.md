...
<p align="center">
<a href="https://lexi-lambda.github.io/blog/2019/11/05/parse-don-t-validate/">Describe your intention in types</a> much more precisely than other frameworks allow, thereby detecting mistakes at compile-time, achieving self-documenting code and tight integration with IDEs. For example, an update of the "message" kind with text inside, received from a chat, which has a photo can be described in a single type!
</p>
