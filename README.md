...
Feel free to propose your own bot to our collection!
 ...
 - [crapstone/hsctt](https://codeberg.org/crapstones-bots/hsctt/src/branch/main/telegram) -- A Telegram bot that searches for HTTP status codes in all messages and replies with the text form.
